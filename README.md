...
from coqpit.coqpit import Coqpit, check_argument, MISSING
...
class SimpleConfig(Coqpit):
    ...
    def check_values(self,):  # you can define explitic constraints on the datacalss fields using `check_argument`
        '''Check config fields'''
        c = asdict(self)
